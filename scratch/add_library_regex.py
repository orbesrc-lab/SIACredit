...
pattern_btn = r'(<button class="sub-tab-btn" id="subTabBtnGradebook"[^>]*>.*?💯 Libro de Calificaciones</button>\s*)(</div>)'
replacement_btn = r'\1    <button class="sub-tab-btn" id="subTabBtnLibrary" onclick="switchSubTab(\'library\')">🌍 Biblioteca Libre (APA 7)</button>\n                    \2'
...
replacement_tab_end = r"""                    <!-- SUB-TAB: BIBLIOTECA ABIERTA -->
